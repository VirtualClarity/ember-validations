...
Ember.Validator = Ember.Object.extend(/**@scope Ember.Validator.prototype */{
  ...
  */
  ...
  optionValue: function(obj, option, type) {
      var val = this.get('options.' + option + '.value') || this.get('options.' + option);
  ...
  /**
    Return the custom message of the option, or null if it is not defined.
  
    @param {Object} object
     The object which contains the message that has to be retrieved
    @param {String} option
     The option you want its custom message
    @param {String} type
    Optional. When renseigned, return null if the value does not match the type
   */
  getCustomMessage: function (obj, option) {
      var message = this.get('options.' + option + '.message');
  ...
  */
  ...
  _validate: function(obj, attr, value) {
    ...
    if (invalidValues.contains(value) || (value.match && value.match(/^\s*$/))) {
        obj.get('validationErrors').add(attr, "blank", null, this.getCustomMessage(obj, ''));
    }
  }
});
...
Ember.Validators.NumericalityValidator = Ember.Validator.extend(/** @scope Ember.Validators.NumericalityValidator.prototype */{
  ...
  _validate: function(obj, attr, value) {
    ...
    if (isNaN(value) || isNaN(parsedValue)) {
        errors.add(attr, 'notNumber', null, this.getCustomMessage(obj, ''));
    } else {
      var options = get(this, 'options');
      if (options.onlyInteger === true && (parsedValue !== parsedInt)) {
          errors.add(attr, 'notInteger', null, this.getCustomMessage(obj, 'onlyInteger'));
      }
      ...
      if (optionValue !== null && parsedValue <= optionValue) {
          errors.add(attr, 'notGreaterThan', { value: optionValue }, this.getCustomMessage(obj, 'greaterThan'));
      }

      optionValue = this.optionValue(obj, 'greaterThanOrEqualTo', 'number');
      if (optionValue !== null && parsedValue < optionValue) {
          errors.add(attr, 'notGreaterThanOrEqualTo', { value: optionValue }, this.getCustomMessage(obj, 'greaterThanOrEqualTo'));
      }

      optionValue = this.optionValue(obj, 'lessThan', 'number');
      if (optionValue !== null && parsedValue >= optionValue) {
          errors.add(attr, 'notLessThan', { value: optionValue }, this.getCustomMessage(obj, 'lessThan'));
      }

      optionValue = this.optionValue(obj, 'lessThanOrEqualTo', 'number');
      if (optionValue !== null && parsedValue > optionValue) {
          errors.add(attr, 'notLessThanOrEqualTo', { value: optionValue }, this.getCustomMessage(obj, 'lessThanOrEqualTo'));
      }

      optionValue = this.optionValue(obj, 'equalTo', 'number');
      if (optionValue !== null && parsedValue !== optionValue) {
          errors.add(attr, 'notEqual', { value: optionValue }, this.getCustomMessage(obj, 'equalTo'));
      }
    }
  },
  ...
  _validate: function(obj, attr, value) {
    ...
    if (optionValue !== null) {
      if (length !== optionValue) {
          errors.add(attr, 'wrongLength', { value: optionValue }, this.getCustomMessage(obj, 'is'));
      }
    } else {

      optionValue = this.optionValue(obj, 'minimum', 'number');
      if (optionValue !== null && length < optionValue) {
          errors.add(attr, 'tooShortLength', { value: optionValue }, this.getCustomMessage(obj, 'minimum'));
      }

      optionValue = this.optionValue(obj, 'maximum', 'number');
      if (optionValue !== null && length > optionValue) {
          errors.add(attr, 'tooLongLength', { value: optionValue }, this.getCustomMessage(obj, 'maximum'));
      }
    }
  }
...
Ember.Validators.FormatValidator = Ember.Validator.extend({
  _validate: function(obj, attr, value) {
    ...
    if ((typeof optionValue === 'string' || optionValue instanceof RegExp) && !value.match(optionValue)) {
        errors.add(attr, 'invalid', null, this.getCustomMessage(obj, this.optionValue(obj, 'with') ? 'with' : ''));
    }

    optionValue = this.optionValue(obj, 'without');
    if ((typeof optionValue === 'string' || optionValue instanceof RegExp) && value.match(optionValue)) {
        errors.add(attr, 'invalid', null, this.getCustomMessage(obj, 'without'));
    }
  }
    ...
    _validate: function( obj, attr, value ) {
      ...
      if( options.property ) {
        if( obj.get( options.property ) !==  value ) {
          obj.get( 'validationErrors' ).add( attr, 'match', null, this.getCustomMessage(obj, 'property') );
        }
      }
    }
